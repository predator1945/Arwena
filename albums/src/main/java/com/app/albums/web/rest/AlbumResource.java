...
import com.app.albums.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.app.albums.domain.Album}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AlbumResource {
    ...
    private static final String ENTITY_NAME = "albumsAlbum";
