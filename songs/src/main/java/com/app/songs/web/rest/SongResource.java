...
import com.app.songs.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.app.songs.domain.Song}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SongResource {
    ...
    private static final String ENTITY_NAME = "songsSong";
